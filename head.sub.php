...
?>
<link rel="shortcut icon" href="./dist/images/etc/favicon.ico" type="image/x-ico" />
...
// js 외부
add_javascript('<script src="./dist/vendor/flickity-docs.min.js"></script>', 0);
add_javascript('<script src="./dist/vendor/slick.min.js"></script>', 0);
// js 내부
add_javascript('<script defer src="./dist/js/comm.js"></script>', 0);
// 폰트
...
add_stylesheet('<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Rubik+Mono+One&display=swap"/>', 0);
// css
// add_stylesheet('<link rel="stylesheet" href="/gnuboard5/dist/css/comm.css">', 0);
add_stylesheet('<link rel="stylesheet" href="./dist/vendor/flickity.css" media="screen" />', 0);
add_stylesheet('<link rel="stylesheet" type="text/css" href="./dist/vendor/slick.css"/>', 0);
add_stylesheet('<link rel="stylesheet" type="text/css" href="./dist/vendor/slick-theme.css"/>', 0);
