...
<div id="hd">
    ...
    <div id="tnb">
        <div class="inner">
			<ul id="hd_qnb">
                ...
                <li><a href="<?php echo G5_BBS_URL ?>/logout.php">Sign Out</a></li>
                <?php if ($is_admin) {  ?>
                <li class="tnb_admin"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>">Administrator</a></li>
                <?php }  ?>
                <?php } else {  ?>
                <li><a href="<?php echo G5_BBS_URL ?>/register.php">Register</a></li>
                <li><a href="<?php echo G5_BBS_URL ?>/login.php">Sign In</a></li>
                <?php }  ?>
            </ul>
    ...
    <div id="hd_wrapper">
        <div class="inner">
            <div id="logo">
                <a href="/gnuboard5/">NASA Reboot</a>
            </div>
